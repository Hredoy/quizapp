                                        ...
                                        <form method="post" class="needs-validation" novalidate="">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-3 col-sm-12">
                                                        ...
                                                        <input name="maximum_coins_winning_percentage" type="number" min=1 class="form-control"  value="<?php echo (!empty($maximum_coins_winning_percentage['message'])) ? $maximum_coins_winning_percentage['message'] : 70 ?>"required>
                                                    </div>
