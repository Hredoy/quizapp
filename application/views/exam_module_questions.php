                        ...
                        <div class="section-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4>Questions for Exam Module <small>View / Update / Delete</small></h4>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table aria-describedby="mydesc" class='table-striped' id='question_list' 
                                                   data-toggle="table" data-url="<?= base_url() . 'Table/exam_module_question' ?>"
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col" data-field="marks">Mark</th>
                            ...
                            <form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <input name="marks" id="marks" type="number" min="1" class="form-control" required placeholder="Enter Mark"/>
                                    </div>
                                </div>
