        ...
        <script type="text/javascript">
            function ckeditor_initialize() {
                const CKEDITOR_CONFIG = {
                    ...
                    const editorIds = ['question', 'a', 'b', 'c', 'd', 'e', 'note'];
        ...
        <script type="text/javascript">
            if(<?= json_encode($question_id)?>){
                ...
                if (question_type == "2") {
                    ...
                    $('#a').val(<?=$data[0]->optiona?>);
                    $('#b').val(<?=$data[0]->optionb?>);
                    $('#tf').show('fast');
                    $('.ntf').show('fast');
                    ...
                    const editorIds = ['a', 'b', 'c', 'd', 'e','option_a_note','option_b_note','option_c_note','option_d_note','option_e_note','note','option_a_note','option_b_note'];    
                    const requiredFieldWarning = 'This field is required.';
